 ...
 var estado= "";              
  ...
  if ( !cep || cep.length!=8 || cep==="00000000" || cep==="11111111" ||cep==="22222222" ||cep==="33333333" ||cep==="44444444" ||cep==="55555555" ||cep==="66666666" ||cep==="77777777" 
  ...
  var urlFinal = "https://www.amildentalvenda.com.br"+ planoUrl + "?cep=" + cep + "&estado=" + estado + "&beneficiarios=" + vidas;
...
function vdChange(){
  ...
  if (vidas==="1"){
      document.getElementById("price-md").innerHTML = "<h3 class='price-modal'> R$ 46,00</h3></div>";
  }
    ...
    if (vidas === "2"){
        ...
        precoDst.style.display = "none";
            document.getElementById("price-md").style.marginTop= "44px"; 
    }
    ...
    if ( !vidas || vidas.length>2 || vidas > 19 || vidas < 1){
        ...
        var preco = (vidas*34);
        document.getElementById("price-md").innerHTML = "<h3 class='price-modal'> R$ " + preco + ",00</h3></div>";
        
    }else{
        msgErroVd.style.display = "none";
        var preco = (vidas*46.50);
        document.getElementById("price-md").innerHTML = "<h3 class='price-modal'> R$ " + preco + ",00</h3></div>";
    }
